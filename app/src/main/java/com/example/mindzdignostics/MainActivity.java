    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        switch (ringermode) {
            case RingerMode.NORMAL:
                deviceDataMap.put(this.getString(R.string.ringer_mode), "normal");
                break;
            case RingerMode.VIBRATE:
                deviceDataMap.put(this.getString(R.string.ringer_mode), "vibrate");
                break;
            case RingerMode.SILENT:
            default:
                deviceDataMap.put(this.getString(R.string.ringer_mode), "silent");
                break;
        }
        ...
        switch (deviceType) {
            case DeviceType.WATCH:
                deviceDataMap.put(this.getString(R.string.device_type), "watch");
                break;
            case DeviceType.PHONE:
                deviceDataMap.put(this.getString(R.string.device_type), "phone");
                break;
            case DeviceType.PHABLET:
                deviceDataMap.put(this.getString(R.string.device_type), "phablet");
                break;
            case DeviceType.TABLET:
                deviceDataMap.put(this.getString(R.string.device_type), "tablet");
                break;
            case DeviceType.TV:
                deviceDataMap.put(this.getString(R.string.device_type), "tv");
                break;
            default:
                //do nothing
                break;
        ...
        switch (phoneType) {
            ...
            case PhoneType.CDMA:
                deviceDataMap.put(this.getString(R.string.phone_type), "CDMA");
                break;
            case PhoneType.GSM:
                deviceDataMap.put(this.getString(R.string.phone_type), "GSM");
                break;
            case PhoneType.NONE:
                deviceDataMap.put(this.getString(R.string.phone_type), "None");
                break;
            default:
                deviceDataMap.put(this.getString(R.string.phone_type), "Unknown");
                break;
        }
        ...
        switch (orientationType) {
            case OrientationType.LANDSCAPE:
                deviceDataMap.put(this.getString(R.string.orientation), "Landscape");
                break;
            case OrientationType.PORTRAIT:
                deviceDataMap.put(this.getString(R.string.orientation), "Portrait");
                break;
            case OrientationType.UNKNOWN:
            default:
                deviceDataMap.put(this.getString(R.string.orientation), "Unknown");
                break;
        }
        ...
        switch (networkType) {
            case NetworkType.CELLULAR_UNKNOWN:
                deviceDataMap.put(this.getString(R.string.network_type), "Cellular Unknown");
                break;
            case NetworkType.CELLULAR_UNIDENTIFIED_GEN:
                deviceDataMap.put(this.getString(R.string.network_type), "Cellular Unidentified Generation");
                break;
            case NetworkType.CELLULAR_2G:
                deviceDataMap.put(this.getString(R.string.network_type), "Cellular 2G");
                break;
            case NetworkType.CELLULAR_3G:
                deviceDataMap.put(this.getString(R.string.network_type), "Cellular 3G");
                break;
            case NetworkType.CELLULAR_4G:
                deviceDataMap.put(this.getString(R.string.network_type), "Cellular 4G");
                break;

            case NetworkType.WIFI_WIFIMAX:
                deviceDataMap.put(this.getString(R.string.network_type), "Wifi/WifiMax");
                break;
            case NetworkType.UNKNOWN:
            default:
                deviceDataMap.put(this.getString(R.string.network_type), "Unknown");
                break;
        }
        ...
        @SuppressLint("WrongConstant") @ChargingVia final int isChargingVia = easyBatteryMod.getChargingSource();
        switch (isChargingVia) {
            case ChargingVia.AC:
                deviceDataMap.put(this.getString(R.string.device_charging_via), "AC");
                break;
            case ChargingVia.USB:
                deviceDataMap.put(this.getString(R.string.device_charging_via), "USB");
                break;
            case ChargingVia.WIRELESS:
                deviceDataMap.put(this.getString(R.string.device_charging_via), "Wireless");
                break;
